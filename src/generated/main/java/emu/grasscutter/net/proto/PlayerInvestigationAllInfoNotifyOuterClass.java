...
public final class PlayerInvestigationAllInfoNotifyOuterClass {
  ...
  public interface PlayerInvestigationAllInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .Investigation investigation_list = 10;</code>
     */
    ...
    /**
     * <code>repeated .InvestigationTarget investigation_target_list = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int INVESTIGATION_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < investigationList_.size(); i++) {
        output.writeMessage(10, investigationList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < investigationList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, investigationList_.get(i));
      }
      for (int i = 0; i < investigationTargetList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
