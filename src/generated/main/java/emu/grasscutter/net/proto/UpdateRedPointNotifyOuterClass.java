...
public final class UpdateRedPointNotifyOuterClass {
  ...
  public interface UpdateRedPointNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .RedPointData red_point_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int RED_POINT_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < redPointList_.size(); i++) {
        output.writeMessage(7, redPointList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < redPointList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, redPointList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "point_list\030\007 \003(\0132\r.RedPointDataB\033\n\031emu.g" +
