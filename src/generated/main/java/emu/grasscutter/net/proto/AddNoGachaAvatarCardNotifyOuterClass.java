...
public final class AddNoGachaAvatarCardNotifyOuterClass {
  ...
  public interface AddNoGachaAvatarCardNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 AIGPMLAPMBL = 14;</code>
     * @return The aIGPMLAPMBL.
     */
    int getAIGPMLAPMBL();
    ...
    /**
     * <code>uint32 KNGMKKHPDBJ = 4;</code>
     * @return The kNGMKKHPDBJ.
     */
    int getKNGMKKHPDBJ();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AIGPMLAPMBL_FIELD_NUMBER = 14;
    private int aIGPMLAPMBL_;
    /**
     * <code>uint32 AIGPMLAPMBL = 14;</code>
     * @return The aIGPMLAPMBL.
     */
    @java.lang.Override
    public int getAIGPMLAPMBL() {
      return aIGPMLAPMBL_;
    }
    ...
    public static final int KNGMKKHPDBJ_FIELD_NUMBER = 4;
    private int kNGMKKHPDBJ_;
    /**
     * <code>uint32 KNGMKKHPDBJ = 4;</code>
     * @return The kNGMKKHPDBJ.
     */
    @java.lang.Override
    public int getKNGMKKHPDBJ() {
      return kNGMKKHPDBJ_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kNGMKKHPDBJ_ != 0) {
        output.writeUInt32(4, kNGMKKHPDBJ_);
      }
      ...
      if (aIGPMLAPMBL_ != 0) {
        output.writeUInt32(14, aIGPMLAPMBL_);
      }
      if (itemId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (kNGMKKHPDBJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, kNGMKKHPDBJ_);
      }
      for (int i = 0; i < transferItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (aIGPMLAPMBL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, aIGPMLAPMBL_);
      }
      if (itemId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getAIGPMLAPMBL()
          != other.getAIGPMLAPMBL()) return false;
      if (getItemId()
          != other.getItemId()) return false;
      if (getAvatarId()
          != other.getAvatarId()) return false;
      if (getKNGMKKHPDBJ()
          != other.getKNGMKKHPDBJ()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + AIGPMLAPMBL_FIELD_NUMBER;
      hash = (53 * hash) + getAIGPMLAPMBL();
      hash = (37 * hash) + ITEM_ID_FIELD_NUMBER;
      hash = (53 * hash) + getItemId();
      hash = (37 * hash) + AVATAR_ID_FIELD_NUMBER;
      hash = (53 * hash) + getAvatarId();
      hash = (37 * hash) + KNGMKKHPDBJ_FIELD_NUMBER;
      hash = (53 * hash) + getKNGMKKHPDBJ();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AddNoGachaAvatarCardNotifyOuterClass.AddNoGachaAvatarCardNotify buildPartial() {
        ...
        result.aIGPMLAPMBL_ = aIGPMLAPMBL_;
        result.itemId_ = itemId_;
        result.avatarId_ = avatarId_;
        result.kNGMKKHPDBJ_ = kNGMKKHPDBJ_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AddNoGachaAvatarCardNotifyOuterClass.AddNoGachaAvatarCardNotify other) {
        ...
        if (other.getAIGPMLAPMBL() != 0) {
          setAIGPMLAPMBL(other.getAIGPMLAPMBL());
        }
        ...
        if (other.getKNGMKKHPDBJ() != 0) {
          setKNGMKKHPDBJ(other.getKNGMKKHPDBJ());
        }
      ...
      /**
       * <code>uint32 AIGPMLAPMBL = 14;</code>
       * @param value The aIGPMLAPMBL to set.
       * @return This builder for chaining.
       */
      public Builder setAIGPMLAPMBL(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearAIGPMLAPMBL() {
      ...
      /**
       * <code>uint32 KNGMKKHPDBJ = 4;</code>
       * @param value The kNGMKKHPDBJ to set.
       * @return This builder for chaining.
       */
      public Builder setKNGMKKHPDBJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKNGMKKHPDBJ() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\023\n\013AIGPMLAPMBL\030\016 \001(\r\022\017\n\007item_id\030\017 \001(\r\022" +
      "\021\n\tavatar_id\030\001 \001(\r\022\023\n\013KNGMKKHPDBJ\030\004 \001(\r\022" +
      "\033\n\023is_transfer_to_item\030\t \001(\010\022=\n\022transfer" +
      "_item_list\030\006 \003(\0132!.AddNoGachaAvatarCardT" +
    ...
    internal_static_AddNoGachaAvatarCardNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AddNoGachaAvatarCardNotify_descriptor,
        new java.lang.String[] { "Reason", "AIGPMLAPMBL", "ItemId", "AvatarId", "KNGMKKHPDBJ", "IsTransferToItem", "TransferItemList", });
    emu.grasscutter.net.proto.AddNoGachaAvatarCardTransferItemOuterClass.getDescriptor();
  }
