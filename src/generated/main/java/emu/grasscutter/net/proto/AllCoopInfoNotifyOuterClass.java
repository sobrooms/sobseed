...
public final class AllCoopInfoNotifyOuterClass {
  ...
  public interface AllCoopInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .MainCoop main_coop_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MAIN_COOP_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < mainCoopList_.size(); i++) {
        output.writeMessage(4, mainCoopList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < mainCoopList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, mainCoopList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\004 \003(\0132\t.MainCoopB\033\n\031emu.grasscutter.net" +
      ".protob\006proto3"
    };
