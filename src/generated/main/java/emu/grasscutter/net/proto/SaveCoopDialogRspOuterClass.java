...
public final class SaveCoopDialogRspOuterClass {
  ...
  public interface SaveCoopDialogRspOrBuilder extends
    ...
    /**
     * <code>uint32 JNIMIKPMODP = 10;</code>
     * @return The jNIMIKPMODP.
     */
    int getJNIMIKPMODP();

    /**
     * <code>uint32 EFLHLGADIOL = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int JNIMIKPMODP_FIELD_NUMBER = 10;
    ...
    public static final int EFLHLGADIOL_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (eFLHLGADIOL_ != 0) {
        output.writeUInt32(8, eFLHLGADIOL_);
      }
      if (retcode_ != 0) {
        output.writeInt32(9, retcode_);
      }
      if (jNIMIKPMODP_ != 0) {
        output.writeUInt32(10, jNIMIKPMODP_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (eFLHLGADIOL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, eFLHLGADIOL_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (jNIMIKPMODP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, jNIMIKPMODP_);
      }
  ...
  static {
    ...
    internal_static_SaveCoopDialogRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SaveCoopDialogRsp_descriptor,
        new java.lang.String[] { "JNIMIKPMODP", "EFLHLGADIOL", "Retcode", });
  }
