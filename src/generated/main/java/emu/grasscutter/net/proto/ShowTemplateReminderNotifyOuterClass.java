...
public final class ShowTemplateReminderNotifyOuterClass {
  ...
  public interface ShowTemplateReminderNotifyOrBuilder extends
    ...
    /**
     * <code>bool NHKGGOIDHKL = 3;</code>
     * @return The nHKGGOIDHKL.
     */
    boolean getNHKGGOIDHKL();

    /**
     * <code>uint32 template_reminder_id = 10;</code>
     * @return The templateReminderId.
     */
    int getTemplateReminderId();

    /**
     * <code>repeated uint32 param_uid_list = 11;</code>
    ...
    /**
     * <code>bool GJKNBONLFAJ = 8;</code>
     * @return The gJKNBONLFAJ.
     */
    boolean getGJKNBONLFAJ();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int NHKGGOIDHKL_FIELD_NUMBER = 3;
    private boolean nHKGGOIDHKL_;
    /**
     * <code>bool NHKGGOIDHKL = 3;</code>
     * @return The nHKGGOIDHKL.
     */
    @java.lang.Override
    public boolean getNHKGGOIDHKL() {
      return nHKGGOIDHKL_;
    }

    public static final int TEMPLATE_REMINDER_ID_FIELD_NUMBER = 10;
    ...
    public static final int PARAM_UID_LIST_FIELD_NUMBER = 11;
    ...
    public static final int GJKNBONLFAJ_FIELD_NUMBER = 8;
    private boolean gJKNBONLFAJ_;
    /**
     * <code>bool GJKNBONLFAJ = 8;</code>
     * @return The gJKNBONLFAJ.
     */
    @java.lang.Override
    public boolean getGJKNBONLFAJ() {
      return gJKNBONLFAJ_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (nHKGGOIDHKL_ != false) {
        output.writeBool(3, nHKGGOIDHKL_);
      }
      ...
      if (gJKNBONLFAJ_ != false) {
        output.writeBool(8, gJKNBONLFAJ_);
      }
      if (templateReminderId_ != 0) {
        output.writeUInt32(10, templateReminderId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (nHKGGOIDHKL_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, nHKGGOIDHKL_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < paramList_.size(); i++) {
      ...
      if (gJKNBONLFAJ_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, gJKNBONLFAJ_);
      }
      if (templateReminderId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, templateReminderId_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < paramUidList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNHKGGOIDHKL()
          != other.getNHKGGOIDHKL()) return false;
      ...
      if (getGJKNBONLFAJ()
          != other.getGJKNBONLFAJ()) return false;
      if (!getParamListList()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NHKGGOIDHKL_FIELD_NUMBER;
      ...
      hash = (37 * hash) + GJKNBONLFAJ_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getGJKNBONLFAJ());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify buildPartial() {
        ...
        result.nHKGGOIDHKL_ = nHKGGOIDHKL_;
        ...
        result.gJKNBONLFAJ_ = gJKNBONLFAJ_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify other) {
        ...
        if (other.getNHKGGOIDHKL() != false) {
          setNHKGGOIDHKL(other.getNHKGGOIDHKL());
        }
        ...
        if (other.getGJKNBONLFAJ() != false) {
          setGJKNBONLFAJ(other.getGJKNBONLFAJ());
        }
      ...
      /**
       * <code>bool NHKGGOIDHKL = 3;</code>
       * @param value The nHKGGOIDHKL to set.
       * @return This builder for chaining.
       */
      public Builder setNHKGGOIDHKL(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNHKGGOIDHKL() {
      ...
      /**
       * <code>bool GJKNBONLFAJ = 8;</code>
       * @param value The gJKNBONLFAJ to set.
       * @return This builder for chaining.
       */
      public Builder setGJKNBONLFAJ(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGJKNBONLFAJ() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "param_uid_list\030\013 \003(\r\022\023\n\013GJKNBONLFAJ\030\010 \001(" +
      "\010\022\022\n\nparam_list\030\007 \003(\005B\033\n\031emu.grasscutter" +
    ...
    internal_static_ShowTemplateReminderNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ShowTemplateReminderNotify_descriptor,
        new java.lang.String[] { "NHKGGOIDHKL", "TemplateReminderId", "ParamUidList", "GJKNBONLFAJ", "ParamList", });
  }
