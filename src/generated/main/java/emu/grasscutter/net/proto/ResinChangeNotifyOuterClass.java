...
public final class ResinChangeNotifyOuterClass {
  ...
  public interface ResinChangeNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 KDJDKFKHOEN = 13;</code>
     * @return The kDJDKFKHOEN.
     */
    int getKDJDKFKHOEN();

    /**
     * <code>uint32 NJLHPIKCNOP = 12;</code>
     * @return The nJLHPIKCNOP.
     */
    int getNJLHPIKCNOP();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 96: {
              ...
              nJLHPIKCNOP_ = input.readUInt32();
              break;
            }
            case 104: {

              kDJDKFKHOEN_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int KDJDKFKHOEN_FIELD_NUMBER = 13;
    private int kDJDKFKHOEN_;
    /**
     * <code>uint32 KDJDKFKHOEN = 13;</code>
     * @return The kDJDKFKHOEN.
     */
    @java.lang.Override
    public int getKDJDKFKHOEN() {
      return kDJDKFKHOEN_;
    }

    public static final int NJLHPIKCNOP_FIELD_NUMBER = 12;
    private int nJLHPIKCNOP_;
    /**
     * <code>uint32 NJLHPIKCNOP = 12;</code>
     * @return The nJLHPIKCNOP.
     */
    @java.lang.Override
    public int getNJLHPIKCNOP() {
      return nJLHPIKCNOP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (nJLHPIKCNOP_ != 0) {
        output.writeUInt32(12, nJLHPIKCNOP_);
      }
      if (kDJDKFKHOEN_ != 0) {
        output.writeUInt32(13, kDJDKFKHOEN_);
      }
      if (curValue_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (nJLHPIKCNOP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, nJLHPIKCNOP_);
      }
      if (kDJDKFKHOEN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, kDJDKFKHOEN_);
      }
      if (curValue_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getKDJDKFKHOEN()
          != other.getKDJDKFKHOEN()) return false;
      if (getNJLHPIKCNOP()
          != other.getNJLHPIKCNOP()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + KDJDKFKHOEN_FIELD_NUMBER;
      hash = (53 * hash) + getKDJDKFKHOEN();
      hash = (37 * hash) + NJLHPIKCNOP_FIELD_NUMBER;
      hash = (53 * hash) + getNJLHPIKCNOP();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ResinChangeNotifyOuterClass.ResinChangeNotify buildPartial() {
        ...
        result.kDJDKFKHOEN_ = kDJDKFKHOEN_;
        result.nJLHPIKCNOP_ = nJLHPIKCNOP_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ResinChangeNotifyOuterClass.ResinChangeNotify other) {
        ...
        if (other.getKDJDKFKHOEN() != 0) {
          setKDJDKFKHOEN(other.getKDJDKFKHOEN());
        }
        if (other.getNJLHPIKCNOP() != 0) {
          setNJLHPIKCNOP(other.getNJLHPIKCNOP());
        }
      ...
      /**
       * <code>uint32 KDJDKFKHOEN = 13;</code>
       * @param value The kDJDKFKHOEN to set.
       * @return This builder for chaining.
       */
      public Builder setKDJDKFKHOEN(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearKDJDKFKHOEN() {
      ...
      /**
       * <code>uint32 NJLHPIKCNOP = 12;</code>
       * @param value The nJLHPIKCNOP to set.
       * @return This builder for chaining.
       */
      public Builder setNJLHPIKCNOP(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNJLHPIKCNOP() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\r \001(\r\022\023\n\013NJLHPIKCNOP\030\014 \001(\rB\033\n\031emu.grass" +
    ...
    internal_static_ResinChangeNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ResinChangeNotify_descriptor,
        new java.lang.String[] { "CurValue", "KDJDKFKHOEN", "NJLHPIKCNOP", });
  }
