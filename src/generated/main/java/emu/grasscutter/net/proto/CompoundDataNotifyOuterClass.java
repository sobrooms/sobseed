...
public final class CompoundDataNotifyOuterClass {
  ...
  public interface CompoundDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 unlock_compound_list = 5;</code>
    ...
    /**
     * <code>repeated .CompoundQueueData compound_que_data_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int UNLOCK_COMPOUND_LIST_FIELD_NUMBER = 5;
    ...
    public static final int COMPOUND_QUE_DATA_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < compoundQueDataList_.size(); i++) {
        output.writeMessage(3, compoundQueDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < compoundQueDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, compoundQueDataList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < unlockCompoundList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ock_compound_list\030\005 \003(\r\0222\n\026compound_que_" +
      "data_list\030\003 \003(\0132\022.CompoundQueueDataB\033\n\031e" +
