...
public final class ReportFightAntiCheatNotifyOuterClass {
  ...
  public interface ReportFightAntiCheatNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 LPNNGAJFGDA = 5;</code>
     * @return The lPNNGAJFGDA.
     */
    int getLPNNGAJFGDA();

    /**
     * <code>uint32 HAIGMMJJDNC = 9;</code>
     * @return The hAIGMMJJDNC.
     */
    int getHAIGMMJJDNC();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              lPNNGAJFGDA_ = input.readUInt32();
              break;
            }
            case 72: {

              hAIGMMJJDNC_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int LPNNGAJFGDA_FIELD_NUMBER = 5;
    private int lPNNGAJFGDA_;
    /**
     * <code>uint32 LPNNGAJFGDA = 5;</code>
     * @return The lPNNGAJFGDA.
     */
    @java.lang.Override
    public int getLPNNGAJFGDA() {
      return lPNNGAJFGDA_;
    }

    public static final int HAIGMMJJDNC_FIELD_NUMBER = 9;
    private int hAIGMMJJDNC_;
    /**
     * <code>uint32 HAIGMMJJDNC = 9;</code>
     * @return The hAIGMMJJDNC.
     */
    @java.lang.Override
    public int getHAIGMMJJDNC() {
      return hAIGMMJJDNC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lPNNGAJFGDA_ != 0) {
        output.writeUInt32(5, lPNNGAJFGDA_);
      }
      if (hAIGMMJJDNC_ != 0) {
        output.writeUInt32(9, hAIGMMJJDNC_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lPNNGAJFGDA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, lPNNGAJFGDA_);
      }
      if (hAIGMMJJDNC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, hAIGMMJJDNC_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLPNNGAJFGDA()
          != other.getLPNNGAJFGDA()) return false;
      if (getHAIGMMJJDNC()
          != other.getHAIGMMJJDNC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LPNNGAJFGDA_FIELD_NUMBER;
      hash = (53 * hash) + getLPNNGAJFGDA();
      hash = (37 * hash) + HAIGMMJJDNC_FIELD_NUMBER;
      hash = (53 * hash) + getHAIGMMJJDNC();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ReportFightAntiCheatNotifyOuterClass.ReportFightAntiCheatNotify buildPartial() {
        ...
        result.lPNNGAJFGDA_ = lPNNGAJFGDA_;
        result.hAIGMMJJDNC_ = hAIGMMJJDNC_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ReportFightAntiCheatNotifyOuterClass.ReportFightAntiCheatNotify other) {
        ...
        if (other.getLPNNGAJFGDA() != 0) {
          setLPNNGAJFGDA(other.getLPNNGAJFGDA());
        }
        if (other.getHAIGMMJJDNC() != 0) {
          setHAIGMMJJDNC(other.getHAIGMMJJDNC());
        }
      ...
      /**
       * <code>uint32 LPNNGAJFGDA = 5;</code>
       * @param value The lPNNGAJFGDA to set.
       * @return This builder for chaining.
       */
      public Builder setLPNNGAJFGDA(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLPNNGAJFGDA() {
      ...
      /**
       * <code>uint32 HAIGMMJJDNC = 9;</code>
       * @param value The hAIGMMJJDNC to set.
       * @return This builder for chaining.
       */
      public Builder setHAIGMMJJDNC(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearHAIGMMJJDNC() {
  ...
  static {
    ...
    internal_static_ReportFightAntiCheatNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReportFightAntiCheatNotify_descriptor,
        new java.lang.String[] { "LPNNGAJFGDA", "HAIGMMJJDNC", });
  }
