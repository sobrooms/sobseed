...
public final class CityReputationExploreInfoOuterClass {
  ...
  public interface CityReputationExploreInfoOrBuilder extends
    ...
    /**
     * <code>uint32 explore_percent = 5;</code>
     * @return The explorePercent.
     */
    int getExplorePercent();

    /**
     * <code>repeated uint32 taken_explore_reward_list = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int EXPLORE_PERCENT_FIELD_NUMBER = 5;
    ...
    public static final int TAKEN_EXPLORE_REWARD_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (explorePercent_ != 0) {
        output.writeUInt32(5, explorePercent_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (explorePercent_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, explorePercent_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < takenExploreRewardList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\005 \001(\r\022!\n\031taken_explore_reward_list\030\007 \003" +
