...
public final class TaskVarNotifyOuterClass {
  ...
  public interface TaskVarNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .TaskVar task_var_list = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TASK_VAR_LIST_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < taskVarList_.size(); i++) {
        output.writeMessage(8, taskVarList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < taskVarList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, taskVarList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "TaskVarNotify\022\037\n\rtask_var_list\030\010 \003(\0132\010.T" +
