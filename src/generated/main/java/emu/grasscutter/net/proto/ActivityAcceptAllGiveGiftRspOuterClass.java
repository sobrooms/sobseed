...
public final class ActivityAcceptAllGiveGiftRspOuterClass {
  ...
  public interface ActivityAcceptAllGiveGiftRspOrBuilder extends
    ...
    /**
     * <code>repeated .ActivityAcceptGiftResultInfo accept_gift_result_info_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ACCEPT_GIFT_RESULT_INFO_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        output.writeMessage(6, acceptGiftResultInfoList_.get(i));
      }
      if (scheduleId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, acceptGiftResultInfoList_.get(i));
      }
      if (scheduleId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_result_info_list\030\006 \003(\0132\035.ActivityAccept" +
      "GiftResultInfo\022\017\n\007retcode\030\001 \001(\005\022\023\n\013sched" +
      "ule_id\030\016 \001(\rB\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
