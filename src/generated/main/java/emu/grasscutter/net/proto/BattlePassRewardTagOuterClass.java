...
public final class BattlePassRewardTagOuterClass {
  ...
  public interface BattlePassRewardTagOrBuilder extends
    ...
    /**
     * <code>.BattlePassUnlockStatus unlock_status = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int UNLOCK_STATUS_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unlockStatus_ != emu.grasscutter.net.proto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_INVALID.getNumber()) {
        output.writeEnum(9, unlockStatus_);
      }
      if (level_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unlockStatus_ != emu.grasscutter.net.proto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_INVALID.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(9, unlockStatus_);
      }
      if (level_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lock_status\030\t \001(\0162\027.BattlePassUnlockStat" +
    ...
    internal_static_BattlePassRewardTag_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BattlePassRewardTag_descriptor,
        new java.lang.String[] { "RewardId", "Level", "UnlockStatus", });
    emu.grasscutter.net.proto.BattlePassUnlockStatusOuterClass.getDescriptor();
  }
