...
public final class ExclusiveRuleNotifyOuterClass {
  ...
  public interface ExclusiveRuleNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ExclusiveRuleInfo rule_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int RULE_INFO_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < ruleInfoList_.size(); i++) {
        output.writeMessage(4, ruleInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < ruleInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, ruleInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ule_info_list\030\004 \003(\0132\022.ExclusiveRuleInfoB" +
