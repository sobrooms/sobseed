...
public final class DungeonChallengeFinishNotifyOuterClass {
  ...
  public interface DungeonChallengeFinishNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 GIDCANHMHNG = 1;</code>
     * @return The gIDCANHMHNG.
     */
    int getGIDCANHMHNG();
    ...
    /**
     * <code>uint32 LLGLNCOOMPM = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GIDCANHMHNG_FIELD_NUMBER = 1;
    private int gIDCANHMHNG_;
    /**
     * <code>uint32 GIDCANHMHNG = 1;</code>
     * @return The gIDCANHMHNG.
     */
    @java.lang.Override
    public int getGIDCANHMHNG() {
      return gIDCANHMHNG_;
    }
    ...
    public static final int LLGLNCOOMPM_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gIDCANHMHNG_ != 0) {
        output.writeUInt32(1, gIDCANHMHNG_);
      }
      ...
      if (lLGLNCOOMPM_ != 0) {
        output.writeUInt32(15, lLGLNCOOMPM_);
      }
      if (detailCase_ == 160) {
    ...
    public int getSerializedSize() {
      ...
      if (gIDCANHMHNG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, gIDCANHMHNG_);
      }
      if (isNewRecord_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lLGLNCOOMPM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, lLGLNCOOMPM_);
      }
      if (detailCase_ == 160) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getGIDCANHMHNG()
          != other.getGIDCANHMHNG()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + GIDCANHMHNG_FIELD_NUMBER;
      hash = (53 * hash) + getGIDCANHMHNG();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.DungeonChallengeFinishNotifyOuterClass.DungeonChallengeFinishNotify buildPartial() {
        ...
        result.gIDCANHMHNG_ = gIDCANHMHNG_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.DungeonChallengeFinishNotifyOuterClass.DungeonChallengeFinishNotify other) {
        ...
        if (other.getGIDCANHMHNG() != 0) {
          setGIDCANHMHNG(other.getGIDCANHMHNG());
        }
      ...
      /**
       * <code>uint32 GIDCANHMHNG = 1;</code>
       * @param value The gIDCANHMHNG to set.
       * @return This builder for chaining.
       */
      public Builder setGIDCANHMHNG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGIDCANHMHNG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo.proto\032\031StrengthenPointData.proto\"\270\005\n\034" +
      "DungeonChallengeFinishNotify\022\023\n\013GIDCANHM" +
      "HNG\030\001 \001(\r\022\027\n\017challenge_index\030\013 \001(\r\022)\n\013fi" +
      "nish_type\030\n \001(\0162\024.ChallengeFinishType\022\023\n" +
      "\013LLGLNCOOMPM\030\017 \001(\r\022\022\n\nis_success\030\004 \001(\010\022\\" +
      "\n\031strengthen_point_data_map\030\006 \003(\01329.Dung" +
      "eonChallengeFinishNotify.StrengthenPoint" +
      "DataMapEntry\022\021\n\ttime_cost\030\003 \001(\r\022\025\n\ris_ne" +
      "w_record\030\002 \001(\010\022Y\n(channeller_slab_loop_d" +
      "ungeon_result_info\030\240\001 \001(\0132$.ChannellerSl" +
      "abLoopDungeonResultInfoH\000\022R\n$effigy_chal" +
      "lenge_dungeon_result_info\030\226\002 \001(\0132!.Effig" +
      "yChallengeDungeonResultInfoH\000\022?\n\032potion_" +
      "dungeon_result_info\030\221\r \001(\0132\030.PotionDunge" +
      "onResultInfoH\000\022?\n\032custom_dungeon_result_" +
      "info\030\324\001 \001(\0132\030.CustomDungeonResultInfoH\000\032" +
    ...
    internal_static_DungeonChallengeFinishNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DungeonChallengeFinishNotify_descriptor,
        new java.lang.String[] { "GIDCANHMHNG", "ChallengeIndex", "FinishType", "LLGLNCOOMPM", "IsSuccess", "StrengthenPointDataMap", "TimeCost", "IsNewRecord", "ChannellerSlabLoopDungeonResultInfo", "EffigyChallengeDungeonResultInfo", "PotionDungeonResultInfo", "CustomDungeonResultInfo", "Detail", });
    internal_static_DungeonChallengeFinishNotify_StrengthenPointDataMapEntry_descriptor =
