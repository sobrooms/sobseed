...
public final class DungeonRestartResultNotifyOuterClass {
  ...
  public interface DungeonRestartResultNotifyOrBuilder extends
    ...
    /**
     * <code>bool is_add_accpet = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_ADD_ACCPET_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isAddAccpet_ != false) {
        output.writeBool(5, isAddAccpet_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (isAddAccpet_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, isAddAccpet_);
      }
